import { IPropsUserProvider } from "app/userProvider/components/UserProvider";
import { IStateApiUserProvider } from "app/userProvider/hooks/useUserProviderState";
...
export function libFormatUser(oidcUser: OidcUser): ILibUser {
